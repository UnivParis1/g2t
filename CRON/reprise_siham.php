				...
				else
				{
					...
					$sql = sprintf("INSERT INTO DECLARATIONTP(AFFECTATIONID,TABTPSPARTIEL,DATEDEMANDE,DATEDEBUT,DATEFIN,DATESTATUT,STATUT) 
								VALUES('%s','%s','%s','%s','%s','%s','%s')",
									$fonctions->my_real_escape_utf8($affectationid),
									$fonctions->my_real_escape_utf8($declarationtp[2]),
									$fonctions->my_real_escape_utf8($declarationtp[3]),
									$fonctions->my_real_escape_utf8($datedebutTP),
									$fonctions->my_real_escape_utf8($declarationtp[5]),
									$fonctions->my_real_escape_utf8($declarationtp[6]),
									$fonctions->my_real_escape_utf8($declarationtp[7]));
