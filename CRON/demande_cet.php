<?php
    ...
    if (mysql_num_rows($query) == 0) {
        ...
        $pdf->Cell(60, 10, "Historique des demandes de congés de CET depuis le $datedebut -- Edité le " . date("d/m/Y"));
        $pdf->Ln(15);
        
        $pdf->SetFont('helvetica', 'B', 11, '', true);
        $pdf->Cell(100, 5, "Identité de l'agent", 1, 0, 'C');
        $pdf->Cell(60, 5, "Date de début", 1, 0, 'C');
        $pdf->Cell(60, 5, "Date de fin", 1, 0, 'C');
        $pdf->Cell(30, 5, "Nbre de jours", 1, 0, 'C');
