...
set PHPDIR=C:\wamp64\bin\php\php7.3.21
...
v%PHPDIR%\php import_affectation_siham.php -d error_log=./log/PHP_Log.log >>./log/trace_cron.log 2>>./log/trace_cron_error.log
...
REM %PHPDIR%\php mail_alerte_reliquats.php -d error_log=./log/PHP_Log.log >>./log/trace_cron.log 2>>./log/trace_cron_error.log
...
%PHPDIR%\php generer_solde.php -d error_log=./log/PHP_Log.log >>./log/trace_cron.log 2>>./log/trace_cron_error.log
