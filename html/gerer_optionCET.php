...
<?php     
    ...
    else
    {
        ...
        if (count($listid)>0)
        {
            echo "Il y a des demandes d'alimentation sur CET pour l'agent " . $agent->identitecomplete() . " qui ne sont en cours de traitement ==> Fin du chargement de la page <br>";
            die();
        }
