...
class MenubarNavigation {
  constructor(domNode) {
    ...
    // } else {
    //   linkURL = location.href + 'toto.php'; //'index.php';
    //   linkTitle = 'Home';
    // }
  ...
  openPopup(menuId, menuitem) {
    ...
    if (popupMenu) {
      ...
      if (this.isPopup[menuId]) {
        ...
        popupMenu.style.left = rect.width - 0 + 'px';
  ...
  onMenuitemClick(event) {
    ...
    if (this.hasPopup(tgt)) {
      if (this.isOpen(tgt)) {
        // On demande de fermer la fenêtre popup fille de l'élement courant (celui qui est click)
        this.closePopup(tgt.nextElementSibling);
      } else {
      ...
      // On a cliqué sur un lien => on doit le suivre

      //////////////////////////
      // A Supprimer
      // window.location=document.tgt.href;
      // this.updateContent(tgt.href, tgt.textContent.trim());
      // this.closePopupAll();
      /////////////////////////
    }
