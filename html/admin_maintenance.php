...
<br>
Gestion du mode maintenance... <br>
<br>
<form name='maintenance_mode' method='post'>
<?php echo "<input type='hidden' name='userid' value='" . $user->harpegeid() ."'>";  ?>
<INPUT type= "radio" name="maintenance" value="on"> Activer le mode maintenance <br>
<INPUT type= "radio" name="maintenance" value="off"> Désactiver le mode maintenance <br>
