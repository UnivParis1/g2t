...
class cet
{
    ...
    public const SIGNATAIRE_LIBELLE = array(cet::SIGNATAIRE_AGENT => "AGENT INDIVIDUEL", cet::SIGNATAIRE_STRUCTURE => "TOUS LES AGENTS D'UNE STRUCTURE", cet::SIGNATAIRE_RESPONSABLE => "RESPONSABLE DE STRUCTURE", cet::SIGNATAIRE_SPECIAL => "UTILISATEUR SPECIAL");
